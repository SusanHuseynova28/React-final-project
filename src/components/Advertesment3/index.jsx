    ...
    <div className="max-w-6xl mx-auto py-6">
      ...
      <div className="flex flex-col md:flex-row bg-gray-800 text-white rounded-lg shadow-lg overflow-hidden h-[24rem]">
        <div className="flex flex-col justify-center p-5 flex-1">
          <span className="bg-pink-500 text-white font-semibold px-3 py-1 rounded-lg text-sm w-[4.8rem] inline-block mb-4">
            Gaming
          </span>
          <h3 className="text-[1.6rem] font-bold mb-3 leading-snug">
            Pico 4 Review: Is It Better Than Quest 2?
          </h3>
          ...
          <p className="text-gray-400 text-sm font-semibold">
            To understand the latest smartwatches and other pro devices, let's
        ...
        <div className="relative flex-1">
          ...
          />
          <div className="absolute top-4 right-4 bg-blue-800 text-white font-bold py-2 px-4 w-[3.2rem] h-[3.2rem] rounded-full flex items-center justify-center">
            85%
          </div>
        </div>
      </div>
