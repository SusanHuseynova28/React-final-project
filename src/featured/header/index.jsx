        ...
        <div className="flex justify-between md:justify-center gap-4 md:gap-[6rem] p-4 border-b bg-white">
          <div className="flex items-center">
            ...
            <Link to="/" className="text-2xl font-bold">
              <img src="https://smartmag.theme-sphere.com/tech-blog/wp-content/uploads/sites/35/2022/11/1techblog-logo.png" alt="Logo" className="h-8" />
            </Link>
          </div>
          <nav className="hidden md:flex items-center space-x-4 text-bold">
            ...
            <Link className='font-bold' to="/phones">Phones</Link>
            <Link className='font-bold' to="/buy-theme">Buy Theme</Link>
          </nav>
