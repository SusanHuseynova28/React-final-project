...
const Home = () => {
  return (
    <div className="home-container flex justify-center items-center gap-4 mt-10 pl-10">
          ...
          <div className=" w-1/2 h-[24rem] bg-white rounded-lg overflow-hidden shadow-md mr-2.5 relative mt-4">
            ...
            <div className="p-2.5">
              <h2 className="text-lg font-bold my-2 p-2">
                Tablet PC Market to Witness Exponential Growth by 2028, Sources
                Say
              </h2>
              <div className="flex items-center">
      ...
      <div className="mb-20">
        <h2 className="text-xl font-bold mb-5">People's Favorite</h2>
        ...
        <div className=" mb-5 flex ">
          <div className="flex justify-between">
            <div>
              <span className="text-fuchsia-600 rounded text-[0.8rem] font-bold h-[2rem] text-">
                Gadgets
              </span>
              <h3 className="text-lg font-bold my-2 w-[15rem]">
